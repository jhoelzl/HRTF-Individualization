function [ data ] = anthro_ari(subject_id,dataset,current_db)

data = 0;

% Import Data
load('../../db/ARI/anthro.mat');

% Generate ARI Subject ID
ari_id = str2num(sprintf('3%06.2f',subject_id));

% Mapping to anthro.mat
subject = find(id == ari_id);

if ((strcmp(current_db,'ari') == 1) && (isempty(subject) == 0))
